...
public class Noticia_2 extends JPanel {
	...
	public Noticia_2() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(Noticia_2.class.getResource("/recursos/imagenes/imagenes_inicio/noticias_carrusel_2_rend.jpg")));
