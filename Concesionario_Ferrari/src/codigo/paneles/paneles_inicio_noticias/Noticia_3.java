...
public class Noticia_3 extends JPanel {
	...
	public Noticia_3() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(Noticia_3.class.getResource("/recursos/imagenes/imagenes_inicio/noticias_carrusel_3_rend.jpg")));
